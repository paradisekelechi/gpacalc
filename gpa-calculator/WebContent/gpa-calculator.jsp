...
<body>
	...
	<div class="container">
		...
		<form action="GpaCalculate" method="post">
		
			<div class="row title_row">
				<a href="Logout">
					<div class="col-md-3 btn btn-primary  calculator_header" style="border-right:#000 solid 1px">
						<h3>Logout</h3>
					</div>
				</a>
				...
				<div class="col-md-6 calculator_header" >
					<div class="col-md-8">
			...
			<div class="row actions_row">
				<div class="col-md-12 calculator_header">
					<h3 style="text-transform:capitalize !important;">${sessionScope.user}, calculate your grade point Average (GPA)</h3>
						...
						<div class="input_fields_wrap" id="courseAdd">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input  type="text" class="form-control" id="course" value =" " name="course" >
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
