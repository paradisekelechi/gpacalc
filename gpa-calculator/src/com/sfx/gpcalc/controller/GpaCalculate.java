...
/**
 * Servlet implementation class GpaCalculate
 */
@WebServlet("/GpaCalculate")
public class GpaCalculate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		response.sendRedirect("gpa-calculator.jsp");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("gpa", formattedGpa);
		request.setAttribute("result", resultClass);
		...
		try {
			request.getRequestDispatcher("gpa-calculator.jsp").forward(request, response);
		} catch (Exception e) {
